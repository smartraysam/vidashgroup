            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href=""><img class="logo"
                            src="{{ asset('welcome/images/logo.jpg') }}" width="180" height="80" alt=""></a>
                </div>
                <!-- Navigation -->
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel" style="width:100%">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="{{ asset('welcome/images/slider/shelter.jpg') }}" alt="Shelter">
                    <div class="overlay">
                        <div class="carousel-caption">
                            <h1>VIDASH SHELTER</h1>
                            <h1 class="second_heading">An Affordable Real Estate Services</h1>
                            <p>We ensure that our clients have value for their
                                money.Our estate are tailored to deliver value to clients.</p>
                            <a class="btn know_btn" href="{{ route('shelter') }}">know more</a>
                            <a class="btn know_btn" href="#portfolio">view project</a>
                        </div>
                    </div>
                </div>
                <div class="item">
                    <img src="{{ asset('welcome/images/slider/bg1.jpg') }}" alt="Paint">
                    <div class="overlay">
                        <div class="carousel-caption">
                            <h3>Beautifully designed</h3>
                            <h1>Use Vidash paint</h1>
                            <h1 class="second_heading">Unique Quality</h1>

                            <p>Our quality paint product bring life to your creativity</p>
                            <a class="btn know_btn" href="{{ route('paint') }}">Read More</a>
                ...
                <div class="item">
                    <img src="{{ asset('welcome/images/slider/logistics.png') }}" alt="Logistics">
                    <div class="overlay">
                        <div class="carousel-caption">
                            <h1>Logistics Services</h1>
                            <h1 class="second_heading">Faster & Secure</h1>
                            <p>Moving your goods and service, secured and safely,</p>
                            <a class="btn know_btn" href="{{ route('logistics') }}">Read More</a>
                        </div>
                    </div>
                </div>
