...
<head>
    ...
    <!-- Fancybox slider -->
    <link rel="stylesheet" href="{{ asset('propertyDetail/css/jquery.fancybox.css') }}" type="text/css"
        media="screen" />
    <!-- Theme color -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <article class="aa-properties-item">
                                                <a class="aa-properties-item-img" href="#">
                                                    <img alt="img"
                                                        src="{{ asset('propertyDetail/img/item/1.jpg') }}">
                                                </a>
                                                ...
                                                <div class="aa-properties-item-content">
                                                    ...
                                                    <div class="aa-properties-about">
                                                        ...
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                            Enim molestiae vero ducimus quibusdam odit vitae.</p>
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <article class="aa-properties-item">
                                                <a class="aa-properties-item-img" href="#">
                                                    <img alt="img"
                                                        src="{{ asset('propertyDetail/img/item/2.jpg') }}">
                                                </a>
                                                <div class="aa-tag for-sale">
                                                    For Sale
                                                </div>
